...
// Define the custom MD3 light theme
...
// Combine navigation and paper themes
export const theme = {
  ...
  fonts: CustomMD3LightTheme.fonts, // Ensure fonts compatibility
  roundness: CustomMD3LightTheme.roundness,
};
